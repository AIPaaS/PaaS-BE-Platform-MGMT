...
/**
 * condition-table: 平台服务申请表[PC_SVC_APPLY]
 */
public class CPcSvcApply implements Condition {
	 ...
	 */
	private Integer startAppId;

	/**
	 * condition-field: 所属应用[APP_ID] operate-LTEqual[<=]
	 */
	private Integer endAppId;


	/**
	 * condition-field: 申请服务[SVC_ID] operate-Equal[=]
	 */
	private Long svcId;


	/**
	 * condition-field: 申请服务[SVC_ID] operate-In[in]
	 */
	private Long[] svcIds;


	/**
	 * condition-field: 申请服务[SVC_ID] operate-GTEqual[>=]
	 */
	private Long startSvcId;

	/**
	 * condition-field: 申请服务[SVC_ID] operate-LTEqual[<=]
	 */
	private Long endSvcId;


	/**
	 * condition-field: 申请人ID[APPLIER_ID] operate-Equal[=]
	 */
	private Long applierId;


	/**
	 * condition-field: 申请人ID[APPLIER_ID] operate-In[in]
	 */
	private Long[] applierIds;


	/**
	 * condition-field: 申请人ID[APPLIER_ID] operate-GTEqual[>=]
	 */
	private Long startApplierId;

	/**
	 * condition-field: 申请人ID[APPLIER_ID] operate-LTEqual[<=]
	 */
	private Long endApplierId;


	/**
	 * condition-field: 申请人姓名[APPLIER_NAME] operate-Like[like]
	 */
	private String applierName;


	/**
	 * condition-field: 申请人姓名[APPLIER_NAME] operate-Equal[=]
	 */
	private String applierNameEqual;


	/**
	 * condition-field: 申请人姓名[APPLIER_NAME] operate-In[in]
	 */
	private String[] applierNames;


	/**
	 * condition-field: 申请人邮箱[APPLIER_EMAIL] operate-Like[like]
	 */
	...
	public Integer getStartAppId() {
		return this.startAppId;
	}
	public void setStartAppId(Integer startAppId) {
		this.startAppId = startAppId;
	}


	public Integer getEndAppId() {
		return this.endAppId;
	}
	public void setEndAppId(Integer endAppId) {
	...
	public Long[] getApplierIds() {
		return this.applierIds;
	}
	public void setApplierIds(Long[] applierIds) {
		this.applierIds = applierIds;
	}


	public Long getStartApplierId() {
		return this.startApplierId;
	}
	public void setStartApplierId(Long startApplierId) {
		this.startApplierId = startApplierId;
	}


	public Long getEndApplierId() {
		return this.endApplierId;
	}
	public void setEndApplierId(Long endApplierId) {
		this.endApplierId = endApplierId;
	}
	...
	public String getApplierNameEqual() {
		return this.applierNameEqual;
	}
	public void setApplierNameEqual(String applierNameEqual) {
		this.applierNameEqual = applierNameEqual;
	}


	public String[] getApplierNames() {
		return this.applierNames;
	}
	public void setApplierNames(String[] applierNames) {
		this.applierNames = applierNames;
	}
