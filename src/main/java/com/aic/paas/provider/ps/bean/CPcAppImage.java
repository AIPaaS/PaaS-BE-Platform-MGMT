...
/**
 * condition-table: 应用镜像表[PC_APP_IMAGE]
 */
public class CPcAppImage implements Condition {
	...
	/**
	 * condition-field: 操作步骤[SETUP_NUM] operate-Equal[=]
	...
	/**
	 * condition-field: 操作步骤[SETUP_NUM] operate-In[in]
	 * 1=容器定义 2=开放服务 3=依赖服务 4=其它参数 9=完成
	 */
	private Integer[] setupNums;


	/**
	 * condition-field: 操作步骤[SETUP_NUM] operate-GTEqual[>=]
	 * 1=容器定义 2=开放服务 3=依赖服务 4=其它参数 9=完成
	 */
	private Integer startSetupNum;

	/**
	 * condition-field: 操作步骤[SETUP_NUM] operate-LTEqual[<=]
	 * 1=容器定义 2=开放服务 3=依赖服务 4=其它参数 9=完成
	 */
	private Integer endSetupNum;
	...
	public Integer[] getSetupNums() {
		return this.setupNums;
	}
	public void setSetupNums(Integer[] setupNums) {
		this.setupNums = setupNums;
	}


	public Integer getStartSetupNum() {
		return this.startSetupNum;
	}
	public void setStartSetupNum(Integer startSetupNum) {
		this.startSetupNum = startSetupNum;
	}


	public Integer getEndSetupNum() {
		return this.endSetupNum;
	}
